// Backlinks Go Here!
const backlinksList= [{
  link: "https://block-blasts-online.github.io",
  text: "TUNNEL",
}, {
  link: "https://block-blasts-online.github.io",
  text: "JUMP",
...
backlinksHTML+= "<li style=\"padding: 10px; display: inline-block; float: left;\">"+
    "<a style=\"padding: 5px;color: #ffffff; text-decoration: none; \" onMouseOver=\"this.style.backgroundColor='#0C1E40';\" onMouseOut=\"this.style.backgroundColor='';\" href= \"//block-blasts-online.github.io\">"+ decodeURIComponent(escape("\xF0\x9F\x8F\xA0")) +" SlopeGame</a>"+
    "</li>";
